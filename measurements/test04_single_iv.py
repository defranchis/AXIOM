...
class test04_single_iv(measurement):
    ...
    def initialise(self):
        ...
        self.volt_meter_address = 16    # gpib address of the multi meter
        
        self.lim_cur = 0.0005           # compliance in [A]
        self.lim_vol = 1000             # compliance in [V]
        self.volt_list = [0, 3, 5, 10, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, \
