        ...
        try:
            for v in self.volt_list:
                ...
                for freq_nom in [5E2, 1E3, 2E3, 3E3, 5E3, 1E4, 2E4, 5E4, 1E5, 1E6]:
                    ...
                    out.append([v, vol, freq, r, r_err, x, x_err, c_s, c_p, r_s, r_p, cur_tot])
                    self.logging.info("\t%8.2f \t%8d \t%8.3f \t%8.3f \t%8.3E \t%8.3E \t%8.3E \t%8.3E \t%8.2E" % (vol, freq, r/1000., x/1000., c_s*10**(12), c_p*10**(12), r_s, r_p, cur_tot))
